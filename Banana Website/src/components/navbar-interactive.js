...
const NavbarInteractive = (props) => {
  return (
    <div className={`navbar-interactive-container ${props.rootClassName} `}>
      <header
        data-thq="thq-navbar"
        className="navbarContainer navbar-interactive-navbar-interactive"
      >
        ...
        <div
          ...
          className="navbar-interactive-mobile-menu1 mobileMenu"
        >
          <div className="navbar-interactive-nav">
            ...
            <nav className="navbar-interactive-links">
              <span className="navbar-interactive-nav12 bodySmall">
                {props.nav12}
              </span>
              <span className="navbar-interactive-nav22 bodySmall">
                {props.nav22}
              </span>
              <span className="navbar-interactive-nav32 bodySmall">
                {props.nav32}
              </span>
            </nav>
